...
echo "---------------------------------------------------------------"
##定义数据中心连接
DB_View='/home/dbfw/dbfw/DBCDataCenter/bin/DBCDataView -P9207 -h127.0.0.1 -uroot -pDBSec@1234 dbfw'
