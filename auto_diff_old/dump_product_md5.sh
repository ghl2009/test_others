...
/home/dbfw/dbfw/DBCDataCenter/bin/DBCDataDump --compact --no-create-info --skip-extended-insert -h127.0.0.1 -P9207 -uroot -p1 --default-character-set=utf8 dbfwsystem "version_component" > $dbfwsystem_table/version_component.sql
