...
"$SCRIPTS_HOME/dbfw_report_template_data.sql"      
"$SCRIPTS_HOME/dbfw_report_template_data_dbfw.sql" 
"$SCRIPTS_HOME/dbfw_report_title_data_dbfw.sql"    
"$SCRIPTS_HOME/dbfw_support_database.sql"          
"$SCRIPTS_HOME/dbfw_syslog_filetype.sql"           
"$SCRIPTS_HOME/procedure.sql"                
"$SCRIPTS_HOME/user_permission_url.sql"            
"$SCRIPTS_HOME/vpatch_dbversion.sql"              
"$SCRIPTS_HOME/vpatch_rules_encrypt.sql"         
"$SCRIPTS_HOME/vpatchrule_for_dbversion.sql"       
"$SCRIPTS_HOME/dbfw_sqltype_detail_data.sql"       
"$SCRIPTS_HOME/dbaa_new_summary_procedure.sql"
"$SCRIPTS_HOME/except_database_schema_data.sql"
"$SCRIPTS_HOME/obj_translation_his.sql"
"./addition.sh"
"./addition_new.sql"
"./vpatch_deal.sql"
)
